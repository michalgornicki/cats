  ...
  return (
    <Router>
      <div>
        <Navigation />
        <Routes>
          <Route path="/" element={<Home cats={catsData} />} />
          <Route path="/Database" element={<Database cats={catsData} />} />
          <Route path="/Create" element={<Create cats={catsData} childnum={childnum} />} />
          <Route path="/Dashboard" element={<Dashboard cats={catsData} />} />
          <Route path="/Favourite" element={<Favourite cats={catsData} />} />
          <Route path="/profiles/:id" element={<Cat cats={catsData} />} />
