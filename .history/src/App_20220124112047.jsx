...
const App = () => {
  const [data0, setData0] = useState([1 : {
    "id": "12",
    "name": "Thora",
    "age": 12,
    "color": "szary",
    "image": "https://i.postimg.cc/T20DM2LY/12.jpg",
    "sex": "kotka",
    "region": "Mazowieckie",
    "city": "Modlin",
    "phone": "345-853-379"
  ...
  2 = {
    ...
    "age": 2,
    "color": "biały",
    "image": "https://i.postimg.cc/FsKJ9t3b/13.jpg",
    "sex": "kotek",
    "region": "Mazowieckie",
    "city": "Warszawa",
    "phone": "384-573-269"
    ...
    <Router>
      <div>
        ...
        <Routes>
          ...
          <Route path="/Create" element={<Create data0={data0} writeData={""} />} />
