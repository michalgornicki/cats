    ...
    <Container>
      ...
      <Card className="card-profile">
        ...
        <Card.Body>
          ...
          <label for="age">Województwo</label>
            <select id="age" className="className="w-75" name="age" onChange={() => console.log(document.getElementById("age").value)}>
              <option value="1">Mazowieckie</option>
              <option value="2">Lubelskie</option>
              <option value="3">Pomorskie</option>
              <option value="4">Małopolskie</option>
              <option value="5">Łódzkie</option>
              <option value="6">Podlaskie</option>
            </select>
