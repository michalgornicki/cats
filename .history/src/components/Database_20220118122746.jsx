  ...
  return (
    <div>
      <Container>
        ...
        .filter((item) => Age.includes(item.region))
        .map((item) => 
      <Card className="card">
      ...
      <Container className="checkboxes">
        <form className="d-flex flex-column m-3">
          ...
          <div><input type="radio" onClick={check} id="region1" name="region" value="Mazowieckie" />
          <label for="vehicle1">Mazowieckie</label>
          </div>
          <div><input type="radio" onClick={check} id="region2" name="region" value="Podlaskie" />
          <label for="vehicle1">Podlaskie</label>
          </div>
          <div><input type="radio" onClick={check} id="region3" name="region" value="Lubelskie" />
        ...
        <form className="d-flex flex-column m-3">
          ...
          <div><input type="radio" id="age1" name="age" value="baby" />
          <label for="vehicle1">0-2 lata</label>
          </div>
          <div><input type="radio" id="age2" name="age" value="young" />
          <label for="vehicle1">3-5 lat</label>
          </div>
          <div><input type="radio" id="age3" name="age" value="adult" />
          <label for="vehicle1">6-10 lat</label>
          </div>
          <div><input type="radio" id="age4" name="age" value="older" />
