    ...
    <div>
      ...
      <Container className="checkboxes">
        ...
        <form className="d-flex flex-column m-3">
          ...
          <div><input type="radio" onClick={() => setMinAge([0, 5])} id="age1" name="age" value="baby" />
          <label for="vehicle1">0-2 lata</label>
          </div>
          <div><input type="radio" onClick={() => setMinAge([0, 5])} id="age2" name="age" value="young" />
          <label for="vehicle1">3-5 lat</label>
          </div>
          <div><input type="radio" onClick={() => setMinAge([0, 5])} id="age3" name="age" value="adult" />
          <label for="vehicle1">6-10 lat</label>
          </div>
          <div><input type="radio" onClick={() => setMinAge([0, 5])} id="age4" name="age" value="older" />
