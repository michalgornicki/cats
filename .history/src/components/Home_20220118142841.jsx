        ...
        <Container className="bg-green w-75 mx-0 my-4 p-3 position-relative">
          <Container className="w-75 m-0">
            ...
            <div className="d-flex justify-content-between">
              <Form.Select onChange={ageToggle} id="form2" aria-label="Default select example">
              ...
              <Form.Select onChange={setSex} id="form3" className="" aria-label="Default select example">
