...
<Navbar className="bg-green mb-4">
    ...
    <Nav className="">
      <Nav.Link><Link className="link-unstyled text-white" to="/Signup">Zarejestruj konto</Link></Nav.Link>
      <Nav.Link><Link className="link-unstyled text-white" to="/Signup">Zaloguj się</Link></Nav.Link>
    </Nav>
    </Container>
  </Navbar>
