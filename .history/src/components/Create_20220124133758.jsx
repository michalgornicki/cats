    ...
    <Container>
      ...
      <Card className="card-profile">
        ...
        <Card.Body>
          ...
          <label for="fname">Wiek</label>
        <input onChange={() => console.log(document.getElementById("name").value)} id ="name" className="my-3" type="text"  name="firstname" placeholder="Wpisz wiek.." />
