    ...
    <div>
      ...
      <Container className="checkboxes">
        <form className="d-flex flex-column m-3">
            <div className="text-uppercase  text-success">Lokalizacja</div>
        ...
        <form className="d-flex flex-column m-3">
            <div className="text-uppercase  text-success">Wiek</div>
        ...
        <form className="d-flex flex-column m-3">
            <div className="text-uppercase text-success">Płeć</div>
