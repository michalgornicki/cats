...
const Find = () => {
  ...
  const catboxName = document.getElementById("cat-box-name").innerHTML = "Znalezione koty:"
  ...
  return (
    <div>
      ...
      <div id="cat-box-name" className="display-6 w-75 m-auto">Losowe kociaki z naszej bazy</div>

      <Container id="cat-box1">
        <Container className="w-75  my-4 d-flex flex-wrap">
 my-4 d-flex flex-wrap">
          {data.map((item) => (
            <Card className="card">
      ...
      <Container id="cat-box2" className="w-75 mx-5 my-4 d-flex flex-wrap">
