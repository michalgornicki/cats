...
const Database = () => {
  ...
  const [Sex, setSex] = useState([ "kocur", "kotka"]);
    ...
    <div>
      ...
      <Container className="checkboxes">
        ...
        <form className="d-flex flex-column m-3">
          ...
          <div><input type="radio" onClick={() => setSex(["kocur" , "kotka"])} id="sex" name="vehicle1" value="kot" />
          <label for="vehicle1">Obie płcie</label>
          </div>
          <div><input type="radio" onClick={sexCheck} id="sex" name="vehicle1" value="kocur" />
          <label for="vehicle1">Kocur</label>
          </div>
