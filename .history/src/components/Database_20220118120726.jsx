...
const Database = () => {
  ...
  const check = () => {
    document.getElementById("region1").checked ? console.log("checked") : console.log("unchecked")
  }
    ...
    <div>
      ...
      <Container className="checkboxes">
        <form className="d-flex flex-column m-3">
          ...
          <div><input type="checkbox" onClick={check} id="region1" name="vehicle1" value="Bike" />
          <label for="vehicle1">Mazowieckie</label>
          </div>
          <div><input type="checkbox" id="region2" name="vehicle1" value="Bike" />
          <label for="vehicle1">Podlaskie</label>
          </div>
          <div><input type="checkbox" id="region3" name="vehicle1" value="Bike" />
