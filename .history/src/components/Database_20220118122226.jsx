    ...
    <div>
      ...
      <Container className="checkboxes">
        <form className="d-flex flex-column m-3">
          ...
          <div><input type="checkbox" onClick={check} id="region1" name="Mazowieckie" value="Mazowieckie" />
          <label for="vehicle1">Mazowieckie</label>
          </div>
          <div><input type="checkbox" onClick={check} id="region2" name="Podlaskie" value="Podlaskie" />
          <label for="vehicle1">Podlaskie</label>
          </div>
          <div><input type="checkbox" onClick={check} id="region3" name="Lubelskie" value="Lubelskie" />
