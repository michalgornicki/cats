...
const Create = (childnum) => {
  ...
  const writeData = () => {
    if (document.getElementById("name").value && document.getElementById("age").value && document.getElementById("color").value &&
  document.getElementById("sex").value) {
    Firebase.database().ref("/").child(childnum.childnum).set({
      id: "1",
